...
class PaperAdmin(admin.ModelAdmin):
    ...
    # List page display
    list_display = ['id', 'title', 'year', 'primary_domain', 'journal', 'origin_filename', 'origin_filemd5', 'origin_filelink', 'markdown_filename', 'markdown_filemd5', 'is_active', 'created_at', 'updated_at']
